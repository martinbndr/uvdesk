...
RUN ./composer.phar require uvdesk/automation-bundle && ./composer.phar require uvdesk/api-bundle && php bin/console doctrine:schema:update --force && php bin/console cache:clear --env prod
